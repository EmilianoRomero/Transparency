//----------------------------------------------------------------------------------------------------------------
//FILE: house_statistics.js
//LINKED TO: house_attendance_statistics.html and house_partyloyalty_statistics.html and fetch_house-statistics.js
//----------------------------------------------------------------------------------------------------------------
...
function separateByParty(membersParty) {
    ...
    housestatistics[0].numberOfReps = repL
    housestatistics[1].numberOfReps = demL
    housestatistics[2].numberOfReps = indL
    housestatistics[3].numberOfReps = membersPartyL
    console.log(repL)
    console.log(demL)
    console.log(indL)
...
function separateVotesByParty(membersVotes, members) {
    ...
    //Declaring the object statistics
    let housestatistics = dataStatHouse.housestatistics;
    housestatistics[0].prcVotedWithParty = avgVotesRep; //Assigning the value to each element in the table
    housestatistics[1].prcVotedWithParty = avgVotesDem;
    housestatistics[2].prcVotedWithParty = avgVotesInd;
    housestatistics[3].prcVotedWithParty = avgVotesMem;
...
//----------------------------------------------------------------------------------------------------------------------
// FEEDING THE HTML WITH THE DATA FOR HOUSE AT GLANCE
//----------------------------------------------------------------------------------------------------------------------

let tbodyGlance = document.getElementById("houseglance")
